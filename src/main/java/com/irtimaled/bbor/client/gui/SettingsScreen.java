        ...
        buildTab(0,
                (x, y, width) -> new AbstractButton(x, y, width, "Active", this.client.world != null) {
                    ...
                    protected int getState() {
                        return active ? ClientRenderer.getActive() ? 2 : 1 : 0;
                    }
                },
                ...
                (x, y, width) -> new BoundingBoxTypeButton(x, y, width, "Spawn Sphere", BoundingBoxType.AFKSphere),
                (x, y, width) -> new BoolSettingButton(x, y, width, "Spawnable Blocks", ConfigManager.renderAFKSpawnableBlocks),
                (x, y, width) -> new IntSettingSlider(x, y, width, 1, 3, "Distance", ConfigManager.afkSpawnableBlocksRenderDistance)
                        .addDisplayValue(1, "Nearest")
                        .addDisplayValue(2, "Nearer")
                        .addDisplayValue(3, "Normal"),

                (x, y, width) -> new BoundingBoxTypeButton(x, y, width, "Biome Borders", BoundingBoxType.BiomeBorder),
                (x, y, width) -> new BoolSettingButton(x, y, width, "Only This Biome", ConfigManager.renderOnlyCurrentBiome),
                (x, y, width) -> new IntSettingSlider(x, y, width, 1, 3, "Distance", ConfigManager.biomeBordersRenderDistance)
                        .addDisplayValue(1, "Nearest")
                        .addDisplayValue(2, "Nearer")
                        .addDisplayValue(3, "Normal"));
        buildTab(1,
                ...
                (x, y, width) -> new BoundingBoxTypeButton(x, y, width, "Villages", BoundingBoxType.Village),
